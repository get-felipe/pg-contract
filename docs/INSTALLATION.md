...
```sh
go install github.com/get-felipe/pg-contract/cmd/pg-contract@v0.1.0-alpha.3
pg-contract version
```
...
Published assets for `v0.1.0-alpha.3`:

- `pg-contract_0.1.0-alpha.3_darwin_amd64.tar.gz`
- `pg-contract_0.1.0-alpha.3_darwin_arm64.tar.gz`
- `pg-contract_0.1.0-alpha.3_linux_amd64.tar.gz`
- `pg-contract_0.1.0-alpha.3_linux_arm64.tar.gz`
- `pg-contract_0.1.0-alpha.3_windows_amd64.zip`
- `pg-contract_0.1.0-alpha.3_windows_arm64.zip`
- `pg-contract_0.1.0-alpha.3_checksums.txt`
