...
- [x] Add the internal contract snapshot model, JSON serialization, validation, and SQL hash helper.
- [x] Implement `pg-contract snapshot` to write `pg-contract.lock.json`.
