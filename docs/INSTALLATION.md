...
```sh
go install github.com/get-felipe/pg-contract/cmd/pg-contract@v0.1.0-alpha.8
pg-contract version
```
...
Published assets for `v0.1.0-alpha.8`:

- `pg-contract_0.1.0-alpha.8_darwin_amd64.tar.gz`
- `pg-contract_0.1.0-alpha.8_darwin_arm64.tar.gz`
- `pg-contract_0.1.0-alpha.8_linux_amd64.tar.gz`
- `pg-contract_0.1.0-alpha.8_linux_arm64.tar.gz`
- `pg-contract_0.1.0-alpha.8_windows_amd64.zip`
- `pg-contract_0.1.0-alpha.8_windows_arm64.zip`
- `pg-contract_0.1.0-alpha.8_checksums.txt`
