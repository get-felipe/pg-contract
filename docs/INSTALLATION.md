...
Published assets for `v0.1.0-alpha.1`:

- `pg-contract_0.1.0-alpha.1_darwin_amd64.tar.gz`
- `pg-contract_0.1.0-alpha.1_darwin_arm64.tar.gz`
- `pg-contract_0.1.0-alpha.1_linux_amd64.tar.gz`
- `pg-contract_0.1.0-alpha.1_linux_arm64.tar.gz`
- `pg-contract_0.1.0-alpha.1_windows_amd64.zip`
- `pg-contract_0.1.0-alpha.1_windows_arm64.zip`
- `pg-contract_0.1.0-alpha.1_checksums.txt`
